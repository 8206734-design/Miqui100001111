...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        case 0:
            ...
            document.getElementById('noBtn').innerHTML = '!OYEEEE. QUE TIENES! XDDD';
        ...
        case 1:
            ...
            document.getElementById('noBtn').innerHTML = '¡AMA, DILE PUEEE XDDDD!';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            document.getElementById('sadGifContainer').style.display = 'none';
            document.getElementById('sadGifContainer2').style.display = 'block';

            // Hacer que el botón "Si" crezca
        ...
        case 2:
            ...
            document.getElementById('noBtn').innerHTML = 'jajaj oe estas segura?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            document.getElementById('sadGifContainer').style.display = 'none';
            document.getElementById('sadGifContainer2').style.display = 'none';
        ...
        case 3:
            ...
            document.getElementById('noBtn').innerHTML = '¿Estas conciente?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 4:
            ...
            document.getElementById('noBtn').innerHTML = 'Piensa pe chata';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 5:
            ...
            document.getElementById('noBtn').innerHTML = 'Comeremos chanfainita en la tia veneno...';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 6:
            ...
            document.getElementById('noBtn').innerHTML = 'Y sopa seca en matute💙.. xd';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 7:
            ...
            document.getElementById('noBtn').innerHTML = 'Pipipii... Ponele que si...';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 16:
            ...
            document.getElementById('noBtn').innerHTML = 'anda dale que siii, xd';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';

            // Hacer que el botón "Sí" crezca
            document.getElementById('siBtn').style.fontSize = '280px';
            document.getElementById('siBtn').style.padding = '280px 420px';
        ...
        case 17:
            ...
            document.getElementById('noBtn').innerHTML = 'AJAJAJAAJJ 😂, ya oe dale que si... Quemaras la maquina xd ';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';

            // Hacer que el botón "Sí" crezca
            document.getElementById('siBtn').style.fontSize = '500px';
            document.getElementById('siBtn').style.padding = '480px 650px';
        ...
        case 18:
                document.getElementById('noBtn').innerHTML = 'Te rayas... xd';
                document.getElementById('noBtn').style.backgroundColor = '#F1330A';
